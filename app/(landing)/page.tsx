            ...
            <div className="mt-10 p-5 bg-gray-100 rounded-lg max-w-3xl mx-auto">
              ...
              <div className="bg-gray-800 text-gray-200 p-3 rounded-md overflow-x-auto">
                <code className="text-sm">
                  docker run -d -p 3000:3000 --name innovcrm -e MONGODB_URI=mongodb://user:passsword@localhost:27017/innovcrm?authSource=innovcrm&readPreference=primary&ssl=false&directConnection=true -e JWT_SECRET=your_jwt_secret kpmrafeeq/innovcrm:amd64
                </code>
              </div>
            </div>
          </div>
